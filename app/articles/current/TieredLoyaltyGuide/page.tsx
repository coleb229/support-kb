...
import s1 from '@/public/current/tieredLoyalty/s1.JPG'
import s2 from '@/public/current/tieredLoyalty/s2.JPG'
import s3 from '@/public/current/tieredLoyalty/s3.JPG'
